@extends('app.layouts.default',["title" => "Espace parrain"])
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" data-editable="false">Filleule</th>
                                                <th data-field="phone" data-editable="false">Contact</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($data as $filleule)
                                                <tr>
                                                    <td></td>
                                                    <td>{{ $filleule->nom ." ". $filleule->prenoms}}</td>
                                                    <td>
                                                        @if($filleule->contact1 != $filleule->contact2)
                                                            {{ $filleule->contact1 ."/". $filleule->contact2}}
                                                        @else
                                                            {{ $filleule->contact1}}
                                                        @endif
                                                    </td>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-field="state" data-checkbox="false"></th>
                                                <th data-field="email" data-editable="false">Filleule</th>
                                                <th data-field="phone" data-editable="false">Montant</th>
                                        ...
                                        <tbody>
                                            @foreach($data->bonus as $bonus)
                                                <tr>
                                                    <td>{{ $data->bonus->don->user->nom . " ".$data->bonus->don->user->prenoms }}</td>
                                                    <td>{{ $data->bonus->montant }}</td>
                                                    <td>{{ $data->bonus->created_at }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
